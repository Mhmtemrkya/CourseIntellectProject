  ...
  pricing: {
    ...
    plans: [
      ...
      },
      {
        id: "4",
        name: "Sürücü Kursu",
        description: "MTSK ve sürücü kursları için",
        // Fiyat henüz belirlenmedi — rakam yerine "Özel Fiyat" gösterilir.
        priceMonthly: 0,
        priceYearly: 0,
        isCustomPrice: true,
        features: [
          "Kursiyer kaydı ve kurs dosyası (evrak takibi)",
          "Direksiyon randevu takvimi ve ders hakkı defteri",
          "Eğitmen–araç ataması ve uygunluk kontrolü",
          "Filo yönetimi: muayene, sigorta, bakım takibi",
          "Teorik eğitim, yoklama ve e-sınav yönetimi",
          "Mezuniyet, sertifika ve QR ile belge doğrulama",
          "Eğitmen, filo, iptal ve kursiyer raporları (CSV/PDF)",
          "Kursiyer ve eğitmen mobil uygulaması",
        ],
        ctaText: "Teklif Alın",
      },
    ],
    ...
    sections: [
      ...
      },
      {
        ...
        links: [
          ...
          { id: "2", label: "SSS", href: "/#sss" },
          { id: "3", label: "KVKK", href: "/kvkk" },
        ],
      },
    ],
    socialLinks: [
      { id: "1", platform: "Twitter", url: "https://twitter.com/schoolasist", icon: "Twitter" },
      { id: "2", platform: "LinkedIn", url: "https://linkedin.com/company/schoolasist", icon: "Linkedin" },
      { id: "3", platform: "Instagram", url: "https://instagram.com/schoolasist", icon: "Instagram" },
      { id: "4", platform: "YouTube", url: "https://youtube.com/@schoolasist", icon: "Youtube" },
    ],
