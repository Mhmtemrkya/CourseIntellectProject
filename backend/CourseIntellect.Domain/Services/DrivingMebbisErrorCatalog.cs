...
public static class DrivingMebbisErrorCatalog
{
    ...
    public static IReadOnlyList<DrivingMebbisErrorTemplate> Defaults { get; } = new DrivingMebbisErrorTemplate[]
    {
        ...
        new(HealthReportMissing, "Sağlık raporu eksik", "Onaylı sağlık raporu bulunmuyor.", "Belge yüklenmemiş, reddedilmiş veya yeniden yükleme bekliyor olabilir.", DrivingMebbisErrorSeverity.Blocking, "Evrak onay kuyruğunu kontrol edin.", "Doğru raporu güvenli evrak alanından yükletin.", "Belgeyi kontrol edip onaylayın."),
