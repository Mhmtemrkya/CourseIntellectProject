...
namespace CourseIntellect.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260823130234_AddRegistrationBlocklistAndSuspicion")]
    partial class AddRegistrationBlocklistAndSuspicion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CourseIntellect.Domain.Entities.ConsentFormRecord", b =>
                {
                    ...
                    b.Property<string>("SignerRelation")
                        .IsRequired()
                        .HasMaxLength(60)
                        .HasColumnType("character varying(60)");
                    ...
                    b.HasIndex("TenantId", "ContextKind", "ContextRefId");

                    b.HasIndex("TenantId", "Status", "StationKey");

                    b.ToTable("consent_form_records", (string)null);
                });

            modelBuilder.Entity("CourseIntellect.Domain.Entities.ConsentFormRequirement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "ContextKind", "ContextKey");

                    b.ToTable("consent_form_requirements", (string)null);
                });
            ...
            modelBuilder.Entity("CourseIntellect.Domain.Entities.ConsentFormTemplate", b =>
                {
                    ...
                    b.HasIndex("TenantId", "IsDeleted", "IsActive", "SortOrder");

                    b.ToTable("consent_form_templates", (string)null);
                });

            modelBuilder.Entity("CourseIntellect.Domain.Entities.ConsentSignatureStation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "StationKey")
                        .IsUnique();

                    b.ToTable("consent_signature_stations", (string)null);
                });
            ...
            modelBuilder.Entity("CourseIntellect.Domain.Entities.CustomRole", b =>
                {
                    ...
                    b.Property<bool>("ModulesRestricted")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("modules_restricted");
            ...
            modelBuilder.Entity("CourseIntellect.Domain.Entities.EnrollmentContract", b =>
                {
                    ...
                    b.Property<decimal>("ScholarshipPercent")
                        .HasPrecision(5, 2)
                        .HasColumnType("numeric(5,2)")
                        .HasColumnName("scholarship_percent");
