...
const branches = ['Matematik', 'Fizik', 'Kimya', 'Biyoloji', 'Türkçe', 'İngilizce', 'Tarih', 'Coğrafya'];
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4 p-4 bg-muted rounded-xl">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">{teacher.branch} Öğretmeni</p>
          <Badge className="bg-brand-accent mt-1">{teacher.classes.length} Sınıf</Badge>
        </div>
      </div>
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <Input id="email" type="email" placeholder="ornek@school.edu" />
          </div>
          <div className="space-y-2">
            <Label htmlFor="phone">Telefon</Label>
            <Input id="phone" type="tel" placeholder="0551 111 22 33" />
          </div>
          <div className="space-y-2">
...
export default function Teachers() {
  ...
  }, [search, branchFilter, sortField, sortDirection]);
    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">{mockTeachers.length} kayıtlı öğretmen</p>
        </div>
        <Button 
        ...
        <CardContent className="p-0">
            ...
            <TableBody>
              {filteredTeachers.map((teacher) => (
                ...
                >
                  ...
                  <TableCell>
                    <Badge className="bg-brand-accent">{teacher.branch}</Badge>
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    {teacher.pendingQuestions > 0 ? (
                      <Badge className="bg-destructive">{teacher.pendingQuestions}</Badge>
                    ) : (
          ...
          {filteredTeachers.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="mt-4 text-lg font-semibold">Öğretmen bulunamadı</h3>
              <p className="text-muted-foreground">Farklı filtreler deneyin veya yeni öğretmen ekleyin.</p>
            </div>
          )}
        </CardContent>
      </Card>
