...
const FINANCE_MENU_ITEMS = [
  ...
  { path: "/finance/refunds", icon: RotateCcw, label: "İadeler", color: "#ef4444" },
...
const ROLE_MENU_GROUPS = {
  ...
  finance: [
    ...
    { id: "accounts", title: "Öğrenci Finans", modules: ["student-accounts", "collections", "refunds", "installments", "late-payments", "discounts-scholarships"] },
...
const MODULE_MENU_REGISTRY = {
  ...
  refunds: { default: { path: "/finance/refunds", icon: RotateCcw, label: "İadeler", color: "#ef4444" } },
  ...
  library: {
    default: { path: "/library", icon: BookOpen, label: "Kütüphane", color: "#0ea5e9" },
    teacher: { path: "/t/library", icon: BookOpen, label: "Kütüphane", color: "#0ea5e9" },
    student: { path: "/s/library", icon: BookOpen, label: "Kütüphane", color: "#0ea5e9" },
...
export function inferModuleKey(item) {
  ...
  const exactPathMap = {
    ...
    // İade, tahsilat paketinin "refund" aksiyonudur; ayrı bir paket modülü
    // değildir. Böylece mevcut kurum paketlerinde menü ve route kilitlenmez.
    "/finance/refunds": "collections",
