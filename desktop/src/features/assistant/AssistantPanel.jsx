...
function StructuredData({ message, onAction }) {
  ...
  return <div className="mt-3 space-y-2">
    ...
    {typeof data.collectedThisMonth === 'number' && <div className="grid grid-cols-1 gap-2">
      <div className="rounded-xl border bg-background/80 p-3"><div className="text-xs text-muted-foreground">{data.periodLabel} tahsilat</div><div className="text-2xl font-bold text-foreground">{formatMoney(data.collectedThisMonth)}</div></div>
