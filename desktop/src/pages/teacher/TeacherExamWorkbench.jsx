        ...
        {plannedExams.map((exam) => {
          ...
          return (
            <Card key={exam.id} className="overflow-hidden border-0 shadow-sm">
              <div className="ci-hero border-b border-border p-6 text-white">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="ci-hero-stat rounded-3xl border border-foreground/10 bg-foreground/12 px-4 py-3 text-right backdrop-blur">
