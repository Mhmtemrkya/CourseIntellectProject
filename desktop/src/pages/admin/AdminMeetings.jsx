...
export default function AdminMeetings() {
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
      <section className="ci-hero rounded-[32px] border border-border p-7 text-white shadow-xl" style={{ background: 'linear-gradient(135deg, var(--brand-p-900, #0f172a) 0%, var(--brand-p-800, #334155) 48%, var(--brand-p-700, #0f766e) 100%)' }}>
        <div className="grid gap-5 lg:grid-cols-[1.35fr_0.65fr] lg:items-end">
          <div>
            <Badge className="ci-hero-label bg-foreground/12 text-white hover:bg-foreground/12">Yönetici Görüşme Denetimi</Badge>
