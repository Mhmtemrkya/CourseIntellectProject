                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  CircleAvatar(
                                    radius: 24,
                                    backgroundColor: _roleColor(thread.contactRole).withValues(alpha: 0.14),
                                          ...
                                          children: [
                                            if (thread.lastMessageFromMe) ...[
                                              Icon(
                                                ...
                                                size: 16,
                                                color: _statusColor(thread.lastMessageStatus),
                                              ),
            ...
            ...recipients.map(
              (recipient) => ListTile(
                ...
                leading: CircleAvatar(
                  backgroundColor: _roleColor(recipient.role).withValues(alpha: 0.14),
                  foregroundColor: _roleColor(recipient.role),
                  child: Icon(_roleIcon(recipient.role)),
                ),
                title: Text(recipient.name),
                subtitle: recipient.subtitle == null ? null : Text(recipient.subtitle!),
