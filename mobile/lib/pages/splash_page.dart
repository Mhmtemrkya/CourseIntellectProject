    ...
    _timer = Timer(const Duration(milliseconds: 900), () {
      ...
      Navigator.pushReplacement(
        ...
        PageRouteBuilder<void>(
          pageBuilder: (context, animation, secondaryAnimation) => const RoleSelectPage(),
      ...
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: isDark
                ? const [Color(0xFF081019), Color(0xFF13293D), Color(0xFF0F172A)]
                : const [Color(0xFFF7FAFC), Color(0xFFE8F1F8), Color(0xFFF8FBFF)],
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Text(
                  'Akademik takip, olcumleme ve kurum yonetimi tek platformda.',
                  textAlign: TextAlign.center,
                  style: Theme.of(context).textTheme.bodyLarge?.copyWith(
                        color: Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.72),
                        height: 1.4,
                      ),
                ),
                const Spacer(),
