...
class AdministrativeRecordsPage extends StatefulWidget {
  ...
  @override
  State<AdministrativeRecordsPage> createState() =>
      _AdministrativeRecordsPageState();
}
                ...
                ..._staff.staff
                    ...
                    .map(
                      (staff) => ListTile(
                        ...
                        subtitle: Text(
                          '${staff.roleType} • ${staff.branchOrDepartment}',
                        ),
                      ),
                    ),
              ],
          ...
          AdminPanel(
            child: Column(
              ...
              children: [
                ...
                _infoTile(
                  context,
                  'Otomatik giriş bilgisi',
                  'Her yeni kayıt sonrası kullanıcı adı ve şifre otomatik üretilir.',
                ),
                _infoTile(
                  context,
                  'Veli iletişim hazırlığı',
                  'Kaydı tamamlanan öğrenci için veli iletişim kartı hazır olur.',
                ),
                _infoTile(
                  context,
                  'Evrak takip mantığı',
                  'Eksik bilgi varsa öğrenci detayında idari not alanından görülebilir.',
                ),
              ],
            ),
          ),
