...
class _VeliDevamsizlikPageState extends State<VeliDevamsizlikPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final records = AttendanceService.instance
        ...
        .where((item) => _status == 'Tumu' || item.status == _status)
        .toList();
    ...
    return Scaffold(
      ...
      appBar: hasSidebar ? null : const AppHeader(title: 'Devamsizlik Takibi'),
      body: _loading
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Gun, hafta ve ay bazinda devamsizlik ve gec kalma hareketleri.',
                ...
                builder: (context, constraints) {
                  ...
                  final controls = [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items: const ['Gun', 'Hafta', 'Ay']
                          .map((item) => DropdownMenuItem(value: item, child: Text(item)))
                          .toList(),
                      onChanged: (value) => setState(() => _period = value ?? 'Ay'),
                    ),
                    DropdownButtonFormField<String>(
                      isExpanded: true,
                      ...
                      items: const ['Tumu', 'Katildi', 'Gec', 'Devamsiz', 'Izinli']
                          ...
                          .toList(),
                      onChanged: (value) => setState(() => _status = value ?? 'Tumu'),
                    ),
                  ];
      ...
      child: Theme(
        ...
        child: ExpansionTile(
          ...
          leading: CircleAvatar(
            ...
            foregroundColor: issueCount == 0 ? const Color(0xFF0F766E) : const Color(0xFFB54708),
            child: Icon(issueCount == 0 ? Icons.check_circle_outline_rounded : Icons.event_busy_outlined),
          ),
          title: Text(dateLabel, style: theme.textTheme.titleSmall?.copyWith(fontWeight: FontWeight.w900)),
          subtitle: Text(
            issueCount == 0 ? 'Tum derslere katildi' : '$issueCount hareket kaydi var',
            style: theme.textTheme.bodySmall,
          ),
          children: records.map((record) => _recordCard(context, record)).toList(),
        ),
      ),
    );
  }
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${record.className} • Yoklama kaydi',
                  style: theme.textTheme.bodySmall,
                ),
              ],
            ),
